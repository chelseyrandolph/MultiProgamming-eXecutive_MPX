...
/*
remove_all is an internal function that removes all the pcbs.
Return Type: void
Parameters: None
*/
void remove_all();
...
Parameters: none
*/
int create_pcb(char name[17], int pclass, int priority); 


/*
delete_pcb will take a pcb name, find it, remove it, and then free all associated memory.
Return Type: int
Parameters: char[17]: the name of the PCB you're trying to delete
*/
int delete_pcb(char name[17]);

/*
block_pcb will take a pcb name the user has given and set its state to blocked.
Return Type: int
Parameters: char[17]: the name of the PCB you're trying to block
*//*This function will take a pcb name the user has given and set its state to blocked.*/
int block_pcb(char name[17]);


/*
unblock_pcb will take a pcb name the user has given and set its state to unblocked.
Return Type: int
Parameters: char[17]: the name of the PCB you're trying to unblock
*/
int unblock_pcb(char name[17]);


/*suspend_pcb will take a pcb name the user has given and set its state to suspended.
Return Type: int
Parameters: char[17]: the name of the PCB you're trying to suspend
*/
int suspend_pcb(char name[17]);


/*
resume_pcb will take a pcb name the user has given and set its state to not suspended.
Return Type: int
Parameters: char[17]: the name of the PCB you're trying to resume
*/
int resume_pcb(char name[17]);


/*
show_pcb will take a pcb name the user has given and displays information about its state.
Return Type: int
Parameters: char[17]: the name of the PCB you're trying to display to the user
*/
int show_pcb(char name[17]);
...
Return Type: int
Parameters: char[17]: the name of the PCB
